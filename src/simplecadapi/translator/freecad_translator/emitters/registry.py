...
EMITTER_METHOD_BY_OP: Dict[str, str] = {
    ...
    "make_add_point_rsketch": "_emit_sketches",
    "make_add_line_rsketch": "_emit_sketches",
    "make_add_circle_rsketch": "_emit_sketches",
    "make_add_arc_rsketch": "_emit_sketches",
    "make_add_bspline_rsketch": "_emit_sketches",
