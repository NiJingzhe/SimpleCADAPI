...
This module runs inside the CadQuery environment (``.venv-cq``, Python 3.11
+ cadquery 2.8).  It never imports simplecadapi: the trace JSON it produces is
the only handoff to the translator side.
"""
