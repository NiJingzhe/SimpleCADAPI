...
Run from the repository root with:
    uv run python examples/constrained_sketch/model.py

Generated files:
    examples/constrained_sketch/out/constrained_sketch.model.json
    examples/constrained_sketch/out/constrained_sketch.step
    examples/constrained_sketch/out/constrained_sketch.FCStd
