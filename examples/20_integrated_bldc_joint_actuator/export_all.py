...
SCRIPTS = (
    "examples/20_integrated_bldc_joint_actuator/export_mjcf.py",
    "examples/20_integrated_bldc_joint_actuator/export_step.py",
    "examples/20_integrated_bldc_joint_actuator/export_fcstd.py",
)
