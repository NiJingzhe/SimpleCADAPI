...
- `16_compact_two_stage_planetary_reducer/` — modular 50 mm diameter, 30 mm tall, 20:1 two-stage herringbone planetary reducer with input/output flanges, reusable stdlib ball bearing placements, graph/model JSON replay, STEP export, and solved gear constraints.
