...
```python
def export_model_json_to_solidworks_step(json_str: str, output_path: str, *, document_name: str = 'SimpleCADModel', visible: bool = False, solidworks_version: str = '2025', python_exe: Optional[str] = None) -> str
```
